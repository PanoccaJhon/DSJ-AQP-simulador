        ...
        else
        {
            if (TriggerObject != null)
            {
                if (TriggerObject.GetComponent<Rigidbody>() != null)
                {
                    ...
                    float CurrentSpeed = TriggerObject.GetComponent<Rigidbody>().linearVelocity.magnitude * Pi;
                    if (currentspeed > 10f)
                    {
                        //float f = new float();
